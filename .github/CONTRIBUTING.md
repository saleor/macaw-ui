# Welcome to MacawUI contribution guide
...
3. You are going to need `pnpm` to install dependencies. You can install it using pnpm [installation guide](https://pnpm.io/installation).
4. Create a working branch and start with your changes!

### Commit your update

Commit the changes once you are happy with them. We are using [Conventional Commits](https://www.conventionalcommits.org/en/v1.0.0/) for our commit messages.
...
Congratulations 🎉🎉 Thank you for contribution to Macaw UI ✨.
