...
const responsiveProperties = defineProperties({
  ...
  properties: {
    ...
    gap: { ...vars.space, ...vars.spacing },
    rowGap: { ...vars.space, ...vars.spacing },
    columnGap: { ...vars.space, ...vars.spacing },
    paddingTop: { ...vars.space, ...vars.spacing },
    paddingBottom: { ...vars.space, ...vars.spacing },
    paddingLeft: { ...vars.space, ...vars.spacing },
    paddingRight: { ...vars.space, ...vars.spacing },
    marginTop: { ...vars.space, ...vars.spacing, auto: "auto" },
    marginBottom: { ...vars.space, ...vars.spacing, auto: "auto" },
    marginLeft: { ...vars.space, ...vars.spacing, auto: "auto" },
    marginRight: { ...vars.space, ...vars.spacing, auto: "auto" },
    width: { ...vars.space, ...vars.spacing, "100%": "100%", "100vw": "100vw" },
    height: {
      ...vars.space,
      ...vars.spacing,
      "100%": "100%",
    ...
    minWidth: { ...vars.space, ...vars.spacing, auto: "auto", "100%": "100%" },
    ...
    top: { ...vars.space, ...vars.spacing },
    bottom: { ...vars.space, ...vars.spacing },
    left: { ...vars.space, ...vars.spacing },
    right: { ...vars.space, ...vars.spacing },
