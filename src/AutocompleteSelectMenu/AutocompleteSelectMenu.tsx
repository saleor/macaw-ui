...
export type AutocompleteSelectMenuOptionalLabelKeys =
  | "label"
  | "helperText"
  | "placeholder";
export type AutocompleteSelectMenuRequiredLabelKeys =
  | "backLabel"
  | "displayLabel"
  | "noResultsLabel";
export type AutocompleteSelectMenuLabels = Record<
  AutocompleteSelectMenuRequiredLabelKeys,
  string
> &
  Partial<Record<AutocompleteSelectMenuOptionalLabelKeys, string>>;

export interface AutocompleteSelectMenuProps
  extends AutocompleteSelectMenuLabels {
  disabled: boolean;
  error: boolean;
  loading: boolean;
  name: string;
...
const AutocompleteSelectMenu: React.FC<AutocompleteSelectMenuProps> = props => {
  ...
  // Reset input value after displayLabel change
  React.useEffect(() => setInputValue(displayLabel), [displayLabel]);
